...
* File Name    : define.h
* Version      : 1.1.0
* Description  : DRP-AI TVM[*1] Application for Line Crossing Object Counting
...
******************************************/
/* Model Binary */
const static std::string model_dir = "line_crossing_yolov3";
...
#define LINE_COUNT_STR_X            (645)
#define LINE_COUNT_STR_Y            (30)
