...
void capture_frame(std::string gstreamer_pipeline )
{
    ...
    while (true)
    {
        ...
        {   
            ...
            putText(output_image, str,Point((DISP_OUTPUT_WIDTH - count_size.width - RIGHT_ALIGN_OFFSET), (LINE_COUNT_STR_Y + count_size.height)), FONT_HERSHEY_SIMPLEX, 
