...
1. Follow the steps below to deploy the project on the board. 
    1. Run the commands below to download the `10_Driver_monitoring_system_deploy_tvm-v221.so` from [Release beta2.0](https://github.com/Ignitarium-Renesas/rzv_ai_apps/releases/tag/beta2.0)
    ```
    ...
    wget https://github.com/Ignitarium-Renesas/rzv_ai_apps/releases/download/beta2.0/10_Driver_monitoring_system_deploy_tvm-v221.so
    ```
