...
|:---|:---|:---|
|<img src=./img/hw_conf_mipi_v2h.png width=600>|<img src=./img/hw_conf_mipi_v2n.png width=600> | <img src=./img/hw_conf_mipi_v2n_fpb.png width=600>|

- For using USB camera  

|RZ/V2H EVK | RZ/V2N EVK | FPB-RZV2N |
|:---|:---|:---|
|<img src=./img/hw_conf_usb_v2h.png width=600>|<img src=./img/hw_conf_usb_v2n.png width=600> | <img src=../01_Head_count/img/hw_conf_v2n_fpb.jpg width=600>|
...
1. Follow the steps below to deploy the project on the board. 
    ...
    1. Run the commands below to download the necessary file.
       ...
       |:---|:---|:---|:---|:---|
       |RZ/V2H EVK|[exe_v2h](./exe_v2h)  |<span style="font-size: small">`https://github.com/Ignitarium-Renesas/rzv_ai_apps/releases/download/v8.10`</span>  |<span style="font-size: small">`10_Driver_monitoring_system_deploy_ruhmi_2026-06_v2h.so`</span> |[Release v8.10](https://github.com/Ignitarium-Renesas/rzv_ai_apps/releases/tag/v8.10)  |
    ...
    2. Rename the `10_Driver_monitoring_system_deploy_ruhmi_2026_06*.so` to `deploy.so`.
    ```
