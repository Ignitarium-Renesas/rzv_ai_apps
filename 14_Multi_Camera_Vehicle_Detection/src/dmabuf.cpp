...
int8_t buffer_alloc_dmabuf1( dma_buffer1 *buffer, int buf_size)
{
    MMNGR_ID id;
    uint32_t phard_addr;
    void *puser_virt_addr;
...
int8_t buffer_alloc_dmabuf2( dma_buffer2 *buffer, int buf_size)
{
    MMNGR_ID id;
    uint32_t phard_addr;
    void *puser_virt_addr;
...
int8_t buffer_alloc_dmabuf3( dma_buffer3 *buffer, int buf_size)
{
    MMNGR_ID id;
    uint32_t phard_addr;
    void *puser_virt_addr;
