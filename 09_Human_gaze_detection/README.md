...
5. Build the application by following the commands below.  
    ...
    make -j$(nproc)
    ```
6. The following application file would be genarated in the `${PROJECT_PATH}/09_Human_gaze_detection/src/build` directory
...
1. Follow the steps below to deploy the project on the board.
    ...
    |:---|:---|:---|:---|:---|
    |RZ/V2H EVK|[exe_v2h](./exe_v2h)  |<span style="font-size: small">`https://github.com/Ignitarium-Renesas/rzv_ai_apps/releases/download/v6.20`</span>  |<span style="font-size: small">`09_Human_gaze_detection_deploy_tvm_v2h-v251.so`</span> |[Release v6.20](https://github.com/Ignitarium-Renesas/rzv_ai_apps/releases/tag/v6.20)  |
