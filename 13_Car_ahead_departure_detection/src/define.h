...
* File Name    : define.h
* Version      : 1.1.0
* Description  : DRP-AI TVM[*1] Application for car ahead departure
...
******************************************/
/* Model Binary */
const static std::string model_dir = "tinyyolov3_car_ahead";
...
#define CAR_STR_X                   (180)
#define CAR_STR_Y                   (240)
