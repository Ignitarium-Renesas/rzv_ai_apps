...
The AI model used for the sample application is [YOLOV3](https://arxiv.org/pdf/1804.02767.pdf) ,[FairFace](https://github.com/dchen236/FairFace).
...
|File | Details |
|:---|:---|
|age_gender_yolov3| Model object files for deployment.|
...
1. Follow the steps below to deploy the project on the board.
    ...
    |:---|:---|:---|:---|:---|
    |RZ/V2H EVK|[exe_v2h](./exe_v2h)  |<span style="font-size: small">`https://github.com/Ignitarium-Renesas/rzv_ai_apps/releases/download/v5.00`</span>  |<span style="font-size: small">`05_Age_gender_detection_deploy_tvm-v230.so`</span> |[Release v5.00](https://github.com/Ignitarium-Renesas/rzv_ai_apps/releases/tag/v5.00)  |
...
## Limitation
1. The classification is dependent on face detected by yolov3.
