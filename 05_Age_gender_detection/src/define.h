...
* File Name    : define.h
* Version      : 1.1.0
* Description  : DRP-AI TVM[*1] Application for Age and gender detection
...
******************************************/
/* Model Binary */
const static std::string model_dir = "age_gender_tinyyolov2";
...
/* Thresholds */
#define TH_PROB                     (0.42f)
#define TH_NMS                      (0.25f)
/* Size of input image to the model */
#define MODEL_IN_W                  (416)
#define MODEL_IN_H                  (416)
#define MODEL1_IN_W                  (224)
#define MODEL1_IN_H                  (224)


/*****************************************
 * Macro for  ResNet-34 pre YOLOV3
 ******************************************/
/* Number of class to be detected */
/* Model Binary */
