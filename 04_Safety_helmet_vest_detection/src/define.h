...
* File Name    : define.h
* Version      : 1.1.0
* Description  : DRP-AI TVM[*1] Application for Safety helmet vest detection
...
******************************************/
/* Model Binary */
const static std::string model_dir = "helmet_vest_yolov3";
...
#define CLASS_LABEL_WIDTH           (108)
#define CLASS_LABEL_WIDTH2          (130)
