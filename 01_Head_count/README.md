...
1. Follow the steps below to deploy the project on the board. 
    1. Run the commands below to download the `01_Head_count_deploy_tvm-v221.so` from [Release beta2.0](https://github.com/Ignitarium-Renesas/rzv_ai_apps/releases/tag/beta2.0)
    ```
    cd ${PROJECT_PATH}/01_Head_count/exe_v2h/head_count_yolov3
    wget https://github.com/Ignitarium-Renesas/rzv_ai_apps/releases/download/beta2.0/01_Head_count_deploy_tvm-v221.so
    ```
